...
export default function Page() {
  return (
    <div className="min-h-screen bg-offwhite flex flex-col items-center justify-center p-4 relative overflow-hidden">
      {/* 装飾的な背景 */}
      <div className="absolute top-[-10%] left-[-10%] w-[40%] aspect-square bg-sage/5 rounded-full blur-3xl" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[40%] aspect-square bg-mustard/5 rounded-full blur-3xl" />
        ...
        <div className="w-full space-y-8">
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="text-center space-y-2">
              ...
              <h1 className="text-2xl font-black text-sage tracking-tighter">住人登録</h1>
              <p className="text-[10px] text-zinc-400 font-bold uppercase tracking-widest">Create Resident Account</p>
            </div>
          </div>
